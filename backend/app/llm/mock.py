...
_TYPE_SIGNATURES: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("SALE_DEED", ("sale deed", "deed of sale", "deed of absolute sale",
                   "absolute sale", "conveyance deed")),
    ("ENCUMBRANCE_CERTIFICATE", ("encumbrance certificate", "encumbrance")),
    ("KHATA_CERTIFICATE", ("khata certificate", "khata extract", "khata")),
    ("PROPERTY_TAX_RECEIPT", ("property tax receipt", "tax paid receipt")),
    ("PROPERTY_DOCUMENT", ("property document", "title deed", "sale agreement")),
...
_FIELD_LABELS: dict[str, tuple[str, ...]] = {
    ...
    "property_address": ("property address", "schedule of property", "property"),
    "property_value": ("property value", "consideration", "sale consideration"),
    "registration_number": ("registration number", "registration no", "document no"),
    "seller_name": ("seller", "seller name", "vendor", "first party", "transferor"),
    "buyer_name": ("buyer", "buyer name", "purchaser", "second party", "transferee"),
    "owner_name": ("owner name", "owner", "khatedar", "assessee"),
    "survey_number": ("survey number", "survey no", "khasra number", "plot number"),
    "khata_number": ("khata number", "khata no", "property account number"),
    "registration_date": ("registration date", "date of registration", "registered on"),
    "ec_period_from": ("period from", "ec period from", "from"),
    "ec_period_to": ("period to", "ec period to", "to"),
    "encumbrance_status": ("encumbrance", "encumbrance status", "encumbrances"),
